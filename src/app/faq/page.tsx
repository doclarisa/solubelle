...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Will rain dissolve my bag before I get to the store?', acceptedAnswer: { '@type': 'Answer', text: `No. Our standard bags are cold-water resistant up to approximately 60°F. Rain won't dissolve them. Hot water (${SPECS.dissolution.hotWaterTemp}) dissolves them completely in ${SPECS.dissolution.hotWaterTime}.` } },
