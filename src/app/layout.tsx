...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Solubelle® | Water-Soluble Grocery Bags | Zero Plastic. Zero Guilt.',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "Solubelle",
              "url": "https://solubelle.com",
              "logo": "https://solubelle.com/logo.png",
              "description": "US distributor of PVA water-soluble grocery bags with zero microplastics.",
              "contactPoint": {
                "@type": "ContactPoint",
